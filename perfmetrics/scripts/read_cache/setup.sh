...
# Install gcsfuse.
CGO_ENABLED=0 go install github.com/Tulsishah/gcsfuse-tulsishah7@read_cache_release

# Clone gcsfuse to get fio load test script.
if [ ! -d "./gcsfuse" ]; then
  git clone -b  read_cache_release https://github.com/Tulsishah/gcsfuse-tulsishah7.git
fi
