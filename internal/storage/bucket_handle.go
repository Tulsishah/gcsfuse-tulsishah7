...
func (bh *bucketHandle) NewReader(
	...
	// https://github.com/Tulsishah/gcsfuse-tulsishah7/blob/34211af652dbaeb012b381a3daf3c94b95f65e00/vendor/cloud.google.com/go/storage/reader.go#L75
	if req.Range != nil {
...
func (b *bucketHandle) DeleteObject(ctx context.Context, req *gcs.DeleteObjectRequest) error {
	...
	// https://github.com/Tulsishah/gcsfuse-tulsishah7/blob/7ad451c6f2ead7992e030503e5b66c555b2ebf71/vendor/cloud.google.com/go/storage/http_client.go#L399
	if err != nil {
		switch ee := err.(type) {
...
func (b *bucketHandle) ListObjects(ctx context.Context, req *gcs.ListObjectsRequest) (listing *gcs.Listing, err error) {
	...
	for {
		...
		// https://github.com/Tulsishah/gcsfuse-tulsishah7/blob/master/vendor/cloud.google.com/go/storage/storage.go#L1304
		// https://github.com/Tulsishah/gcsfuse-tulsishah7/blob/master/vendor/cloud.google.com/go/storage/http_client.go#L370
		if attrs.Prefix != "" {
		...
		// to https://github.com/Tulsishah/gcsfuse-tulsishah7/blob/master/vendor/github.com/jacobsa/gcloud/gcs/bucket.go#L164
...
func (b *bucketHandle) UpdateObject(ctx context.Context, req *gcs.UpdateObjectRequest) (o *gcs.Object, err error) {
	...
	// If storage object does not exist, httpclient is returning ErrObjectNotExist error instead of googleapi error
	// https://github.com/Tulsishah/gcsfuse-tulsishah7/blob/master/vendor/cloud.google.com/go/storage/http_client.go#L516
	switch ee := err.(type) {
	case *googleapi.Error:
		if ee.Code == http.StatusPreconditionFailed {
			err = &gcs.PreconditionError{Err: ee}
...
func (b *bucketHandle) ComposeObjects(ctx context.Context, req *gcs.ComposeObjectsRequest) (o *gcs.Object, err error) {
	...
	// https://github.com/Tulsishah/gcsfuse-tulsishah7/blob/7ad451c6f2ead7992e030503e5b66c555b2ebf71/vendor/cloud.google.com/go/storage/copy.go#L230
	...
	// https://github.com/Tulsishah/gcsfuse-tulsishah7/blob/7ad451c6f2ead7992e030503e5b66c555b2ebf71/vendor/cloud.google.com/go/storage/storage.go#L1739
